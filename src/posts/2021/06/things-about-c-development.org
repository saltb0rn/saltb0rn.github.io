...
=ASan= 已经集成到 =GCC= 里面了, 具体用法可以看[[https://github.com/google/sanitizers/wiki/AddressSanitizer][这里]].
...
- 良好的 =ABI= 兼容性
  ...
  另外也可以参考这个 [[https://www.oracle.com/technical-resources/articles/it-infrastructure/mixing-c-and-cplusplus.html][Mixing C and C++ Code in the Same Program]] 来对本人提供的例子进行说明补充.
